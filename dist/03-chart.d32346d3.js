...
var nyc = [-74, 40];
var sf = [-122, 37];
var shanghai = [121.4737, 31.2304];

var projection = d3.geoOrthographic();
var path = d3.geoPath().projection(projection);

d3.json(require('./data/world.topojson')).then(ready).catch(function (err) {
...
function ready(json) {
  ...
  svg.append('path').datum({ type: 'Sphere' }).attr('d', path).attr('class', 'sphere').attr('fill', '#81DAF5').attr('stroke', 'black').attr('stroke-width', 2);

  svg.append('g').selectAll('.country').data(countries.features).enter().append('path').attr('class', 'country').attr('d', path).attr('fill', '#F5ECCE').attr('stroke', 'black').attr('stroke-width', 0.1);

  d3.select('#step-nyc').on('stepin', function () {
    d3.transition().duration(500).tween('rotate', function () {
      var target = [-nyc[0], -nyc[1]];
      var rotationInterpolator = d3.interpolate(projection.rotate(), target);
      return function (t) {
  ...
  d3.select('#step-sf').on('stepin', function () {
    d3.transition().duration(500).tween('rotate', function () {
      var target = [-sf[0], -sf[1]];
      var rotationInterpolator = d3.interpolate(projection.rotate(), target);
      return function (t) {
        var currentRotation = rotationInterpolator(t);
        projection.rotate(currentRotation);
  ...
  d3.select('#step-shanghai').on('stepin', function () {
    d3.transition().duration(500).tween('rotate', function () {
      var target = [-shanghai[0], -shanghai[1]];
      var rotationInterpolator = d3.interpolate(projection.rotate(), target);
      return function (t) {
        var currentRotation = rotationInterpolator(t);
        projection.rotate(currentRotation);
...
},{"d3":"..\\node_modules\\d3\\index.js","topojson":"..\\node_modules\\topojson\\index.js","./data/world.topojson":"data\\world.topojson"}],"..\\..\\..\\..\\AppData\\Roaming\\npm\\node_modules\\parcel\\src\\builtins\\hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["..\\..\\..\\..\\AppData\\Roaming\\npm\\node_modules\\parcel\\src\\builtins\\hmr-runtime.js","03-chart.js"], null)
//# sourceMappingURL=/03-chart.d32346d3.map